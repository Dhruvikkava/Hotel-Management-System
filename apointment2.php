...
<?php
    ...
    $dates = $_GET['date'];
    $select = "SELECT * FROM `menu of items` WHERE `date`='$dates'";
    $qry = mysqli_query($con,$select);
    $reasult =mysqli_fetch_array($qry);
    ...
    {   
        ...
        $updatequery = "UPDATE `menu of items` SET `date`='$dob',`username`='$username',
                        `breakfast`='$breakfast',`Lunch`='$lunch',`Dinner`='$dinner' WHERE `date`='$newdates'";
            ...
            <div class="bookroom text-white px-3 animate__animated animate__bounceInRight" style="animation-duration: 3s;">
                <form method="POST">
                    ...
                    <div id="accordion">
                            ...
                            DATE: <input  type="date" name="dob" value="<?php echo $reasult['date']?>">
                            </div>
                        <div class="card">
                        <div class="card-header">
                            <a class="card-link" data-toggle="collapse" href="#collapseOne">
                            Enter Breakfast:&nbsp&nbsp&nbsp<input type="text" name="breakfast" value="<?php echo $reasult['breakfast']?>">
                            </a>
                        </div>
                        ...
                        <div class="card-header">
                            ...
                            Enter Lunch:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="lunch" value="<?php echo $reasult['Lunch']?>">
                        </a>
                        </div>
                        ...
                        <div class="card-header">
                            ...
                            Enter Dinner:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="dinner" value="<?php echo $reasult['Dinner']?>">
                            </a>
                        </div>
                        ...
                        <button class="btn bg-warning float-right my-3" type="submit" name="sub">UPDATE</button>
